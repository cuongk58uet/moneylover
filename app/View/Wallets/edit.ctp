...
<body>
	...
	<div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><?php echo $this->Form->postLink(__(' Xóa'), array('action' => 'delete', $this->Form->value('Wallet.id')), array('confirm' => __(' Bạn có chắc chắn muốn xóa %s?', $this->Form->value('Wallet.wallet_name')))); ?></li>
