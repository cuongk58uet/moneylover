...
<body>
	...
	<div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><?php echo $this->Html->link(__(' Các giao dịch'), array('action' => 'index')); ?></li>
			...
			<li><?php echo $this->Html->link(__(' Thêm danh mục giao dịch mới'), array('controller' => 'categories', 'action' => 'add')); ?> </li>
          </ul>
	</div>
