...
<body>
	...
	<div class="col-sm-3 col-md-2 sidebar">
          ...
          <?php endif ?>
			...
			<li class="dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown" id="menu">Danh sách ví <span class="caret"></span></a>
					<ul class="dropdown-menu nav nav-sidebar">
						<li><?php echo $this->Html->link(__('Tất cả các ví'), array('controller' => 'wallets', 'action' => 'index')); ?></li>
						<?php foreach($wallet_data as $wallet): ?>
							<li><?php echo $this->Html->link(__($wallet['Wallet']['wallet_name']), '/thong-tin-vi/'.$wallet['Wallet']['slug']); ?></li>
						<?php endforeach; ?>
			        </ul>
		    </li>
          </ul>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<div class="transactions index">
			<?php if(empty($wallets)): ?>
				<h3>Ohhh!!! Xin chào <b><?php echo $user_info['User']['fullname'];?></b></h3>
			...
			<?php if(!empty($transactions)): ?>
				...
				<div class="panel panel-primary">
					...
					<tr>
						...
						<td style="padding:5px"><?php echo $this->Form->input('create_date', array(
							'label' => false,
							'class'=>"form-control",
							'type' => 'text',
						...
						<td> <?php echo $this->Form->button('Tìm kiếm',array('type' => 'submit','class'=>'btn btn-primary ')); ?></td>
					</tr>
